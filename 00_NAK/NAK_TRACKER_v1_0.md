...
changelog:
  - v1.3 (2026-04-30): W2 wave-close ceremony. All W2 runs closed. active_wave→W3.
    W3 brief flags set true. Design system FINAL, error framework FINAL,
    component audit FINAL confirmed from run closure reports.
  - v1.2 (2026-04-30): W1 wave-close. All W1 runs closed. active_wave→W2.
  - v1.1 (2026-04-30): W0 closed. w0_closed→true. active_wave→W1. W1 briefs authored.
...
active_runs: [W3-R1, W3-R2, W3-R3]
last_session_id: NAK-W2-R3-2026-04-30
last_close_at: 2026-04-30
next_committed_to: W3 Verification + Polish

# W0 gate flag
w0_closed: true

# W1 fan-out readiness
w1_r1_brief_authored: true
w1_r2_brief_authored: true
w1_r3_brief_authored: true

# W2 fan-out readiness
w2_r1_brief_authored: true
w2_r2_brief_authored: true
w2_r3_brief_authored: true

# W3 fan-out readiness
w3_r1_brief_authored: true
w3_r2_brief_authored: true
w3_r3_brief_authored: true

# Project close gates (all must be true for nak_status → COMPLETE)
design_system_final: true           # NAK_DESIGN_SYSTEM_v1_0.md → v1.2 FINAL (W2-R1)
error_framework_final: true         # NAK_ERROR_FRAMEWORK_v1_0.md → v2.0 FINAL (W2-R2)
component_audit_final: true         # NAK_COMPONENT_AUDIT_v1_0.md → FINAL (W2-R3)
portal_math_audit_final: false      # NAK_PORTAL_MATH_AUDIT_v1_0.md — W3-R2 to seal
consistency_checklist_final: false  # NAK_CONSISTENCY_CHECKLIST_v1_0.md — W3-R1 to author
test_baseline_preserved: false      # confirmed at W3-R2 close
```
