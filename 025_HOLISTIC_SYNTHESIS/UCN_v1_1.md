...
architecture_ref: "§G.4 UCN specification"
revision_scope: "Material error correction (Jupiter placement) + §IX.2 correct-response audit + gap register update. Non-erroneous UCN v1.0 content continues to apply unchanged."
---
