...
supersedes_partial: "UCN_v2_0.md §VI.4 (Seven-Mechanism Spiritual → Six-Mechanism); UCN_v1_1.md sections citing v6.0 special lagna values"
scope: "UCN v3.0 — v8.0 reconciliation corrections + 7H reframing + Spiritual six-mechanism + Ketu MD reframe + Mercury 8-system + Gaja-Kesari D-9 + classical yoga constellation update + Ishta/Kashta quantitative reinforcement"
parent_artifacts: [UCN_v1_0.md, UCN_v1_1.md, UCN_v2_0.md, MSR_v2_0.md, FORENSIC_DATA_v8_0_SUPPLEMENT.md, JHORA_TRANSCRIPTION_v8_0_SOURCE.md, V8_0_RECONCILIATION_REPORT.md]
