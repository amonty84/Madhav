...
D7 covers: father (9H, Sun karaka), mother (4H, Moon karaka), paternal dharmic transmission (9H Jupiter), maternal emotional foundation (4H Cancer, Mandi-shadow), parental longevity themes, and the generational dharmic flow through the 1H-5H-9H trine.

### §2 — Executive Summary

The parental domain architecture:
- **Father (9H)**: Jupiter+Venus tenants; Sun (father karaka) in 10H Capricorn (Sun's enemy sign but Dig Bala max); father's dharmic-spiritual quality structurally strong
- **Mother (4H)**: Cancer, untenanted; Moon (mother karaka) in 11H Aquarius; Mandi in 4H creates slight emotional-security background
- **Both parents in 9H by Chara Karaka**: GK Jupiter (father) + MK Venus (mother) both in 9H = both parents are structurally connected to dharmic domain, not just father
- **Empirical confirmation**: Father (Mahendra Mohanty, deceased 2018-02-05 — note the exact same date as native's birthday, 34 years later) had a dharmic-disciplined character consistent with Jupiter-Venus 9H architecture; the kidney disease arc 2013-2018 was a Venus-9H-2L affliction (Venus rules 2L wealth + represents life-force flow; kidneys in Ayurveda connect to water/Kapha which Venus governs)

---

## PART II — THE FOUNDATIONAL READING

### §3 — The 9H as Father's House AND Dharma House

9H Sagittarius holds Jupiter (9L own sign) + Venus (7L + 2L + MK). Jupiter is the Chara GK (Gnatikaraka — rivals/relatives, but in Sthira Karaka framework Jupiter = father-significator-like role). Sun is the Sthira Karaka for father (pitru karaka).

**Father's architecture**:
- Jupiter in 9H own sign = Father's dharmic strength is architecturally maximum
- Sun in 10H enemy sign but Dig Bala max = Father's worldly position is elevated (10H Kendra) but expressed through Saturn's domain (career hierarchy, structured authority)
- Father = Mahendra Mohanty (LEL confirmation): banking/finance background, hierarchical corporate structure — consistent with Sun-in-Capricorn Saturnian career expression
- Father's kidney illness 2013-2018: Venus (in 9H, 2L) affliction during the native's Rahu AD (2011-2014) and Jupiter AD (2014-2022) = Venus's 9H placement subjected to Rahu-ascendant then Jupiter-AD-testing; kidney = Venus-governed in Ayurveda
- Father deceased 2018-02-05: died on native's birthday; Vimshottari was Jupiter AD / Jupiter PD ending soon → Saturn AD; Jupiter's end marked the father's completion

### §4 — The 4H as Mother's House

4H Cancer is untenanted; ruled by Moon (in 11H Aquarius). Mother = Moon karaka.

**Mother's architecture**:
- 4H empty; Moon-lord in 11H (community/gains) = mother's primary orientation is community-oriented rather than domestic
- Venus MK (Matrukaraka) in 9H = mother's dharmic quality is strong (Venus in Jupiter's sign in dharma trine)
- Mandi in 4H (Cancer 14°13' Ashlesha): creates slight background malefic shadow on the emotional-security domain
- Moon's Jaimini aspect on 4H (Aquarius fixed → Cancer fixed): Moon from 11H has Jaimini Rashi Drishti on its own house; mother-significator maintains connection to its own karaka-house even from a distance

**Practical**: Mother's dharmic orientation is strong (Venus 9H) but the domestic/home aspect carries Mandi-shadow quality — not severe difficulty but a persistent background-level unease in the 4H domain rather than warm emotional ease.

### §5 — 1H-5H-9H Generational Dharmic Flow

Covered in Children Report §7. The native is the middle link in a Jupiter-supervised dharmic transmission chain:
- 9H (paternal dharma) → Jupiter supervises this
- 1H (native's identity) → Jupiter's 5th aspect from 9H
- 5H (progeny/creativity) → Jupiter's 9th aspect from 9H

The dharmic continuity from ancestors through native to next-generation is architecturally structured. This is a significant finding: parental blessing flows through the native's 1H and forward to 5H via Jupiter's three-aspect pattern from 9H.

### §6 — Cross-Domain Linkages: CDLM D7 Row

| Cell | Strength | Key Finding |
|---|---|---|
| D7.D1 | 0.71 | Parents provide dharmic foundation for career (9H paternal dharma → 10H career) |
| D7.D2 | 0.68 | Parental wealth-transmission (2H lord Venus in 9H dharmic house) |
| D7.D3 | 0.60 | Moderate; relationships partially constrain parental domain |
| D7.D4 | 0.65 | Parental health lineage; Mandi 4H emotional-security subtle shadow |
| D7.D5 | 0.75 | Parents feed children domain (dharmic axis 1H-5H-9H) |
| D7.D6 | 0.82 | Father's house = spirit's house; strong parent-spirit fusion |
| D7.D7 | 0.70 | Self-amplification moderate (one parent deceased, one active) |
| D7.D8 | 0.70 | Philosophical mind has parental roots (paternal dharma) |
| D7.D9 | 0.65 | Parents' blessing enables foreign residence (father's career consent to Singapore move 2007) |

### §7 — Timing

**Current period**: Father deceased 2018. Mother status: LEL indicates mother is alive; relationship appears functional per LEL context. No specific parental-domain timing windows currently active.

**Maternal longevity window**: Moon is in 11H Aquarius; Moon receives Jaimini aspect to Cancer 4H (mother's house); Moon's condition is Susupta/Mrat/Shant — a quiet peaceful state. No acute 4H stress indicators currently. The Ketu MD (2031-2038) activates 8H themes; 8H is the 5th from 4H (mother's longevity house), which requires attention during that period.

---

## PART III — OPERATING NOTES

The parental domain is not primarily a challenge-domain in this chart. It is:
- Dharmically well-endowed (paternal 9H Jupiter; maternal MK Venus 9H)
