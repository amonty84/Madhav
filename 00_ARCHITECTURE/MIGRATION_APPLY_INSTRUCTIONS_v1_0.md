...
changelog:
  - v1.0 (2026-05-01, M3-PRE-D-GOVERNANCE-2026-05-01): Initial authoring. Live
    ...
    inspect each file or use the supabase CLI's migration tracking to be safe.
---
...
SQL files or the supabase migration tracker if exact apply-state of
those five is required.
...
The CLI tracks which migrations are already applied and skips them.
